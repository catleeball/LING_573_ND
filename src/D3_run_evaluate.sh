...
EVAL_DATA_FILE="$PROJECT_ROOT/data/sarc/toy_comments-train-balanced.json"
...
# preprocess data - COMMENT OUT IF ALREADY DONE in D2
# cd $PROJECT_ROOT/src/dev_partition/
# ./make_dev_set.sh $EVAL_DATA_FILE
# cd $PROJECT_ROOT

# run evaluation on each model:
# @EMMA - edit/add lines below to reflect arg changes in evaluation.py
