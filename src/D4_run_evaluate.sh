...
OUTPUT_FILE="outputs/D4/d4_ensemble_sarc_d3_model.out"          # will be rewritten during param tuning -- rerun final model.
...
ENSEMBLE_FILE="outputs/D4/ensembles/sarc_no_context_ensemble_model_max30.pkl"
python -m src.model.ensemble_model --data_file $DATA_FILE --load_preds $BASE_OUTPUT_1 $BASE_OUTPUT_2 --ensemble_file $ENSEMBLE_FILE --output_file $OUTPUT_FILE

ENSEMBLE_FILE="outputs/D4/ensembles/sarc_no_context_ensemble_model_entropy.pkl"
python -m src.model.ensemble_model --data_file $DATA_FILE --load_preds $BASE_OUTPUT_1 $BASE_OUTPUT_2 --ensemble_file $ENSEMBLE_FILE --output_file $OUTPUT_FILE
